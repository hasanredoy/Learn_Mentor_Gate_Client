...
const Banner = () => {
  return (
    <div className=" flex flex-col lg:flex-row gap-5">
     ...
     <h1 className="  text-4xl font-bold "> <span className="  rounded-tr-2xl rounded-bl-2xl bg-green-600 text-white " >Unlock</span> Your Path to Expert-Led
     <br /> Online <span className=" text-green-600">Learning</span></h1>
     <p>Learn Mentor Gate is your premier destination for quality online education. Connect with expert mentors and access a wide variety of courses designed to help you achieve your academic and professional goals.</p>
