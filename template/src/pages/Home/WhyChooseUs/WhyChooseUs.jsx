  ...
  return (
    ...
    <div className="hero-content text-center text-neutral-content">
      ...
      <div className=" my-5  text-black mx-auto flex flex-col lg:flex-row gap-5">
          <div data-aos-duration={1000} data-aos={'zoom-in'} className="stat flex justify-center items-center flex-row-reverse min-w-[300px] w-full bg-green-50 border border-b-8 border-orange-300 border-r-8 ">
          ...
          <div data-aos-duration={1000} data-aos='zoom-out'   className="stat flex justify-center items-center flex-row-reverse min-w-[300px] w-full bg-green-50 border border-b-8 border-purple-300 border-r-8 ">
            <div className="stat-figure text-secondary">
          ...
          <div  data-aos-duration={1000} data-aos='zoom-in'   className="stat flex justify-center items-center flex-row-reverse min-w-[300px] w-full bg-green-50 border border-b-8 border-yellow-300 border-r-8 ">
            <div className="stat-figure text-secondary">
