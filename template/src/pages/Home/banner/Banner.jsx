...
const Banner = () => {
 ...
 <section className="flex flex-col lg:flex-row   w-[95%] lg:w-[86%] mx-auto" >
 <div className="w-full lg:w-1/2 flex text-center lg:text-start justify-center items-center lg:items-start flex-col gap-5 px-1 lg:px-10 py-3">
     ...
     <p className=" text-sm ">Learn Mentor Gate is your premier destination for quality online education. Connect with expert mentors and access a wide variety of courses designed to help you achieve your academic and professional goals.</p>
     <Link to={'/allClasses'}>
