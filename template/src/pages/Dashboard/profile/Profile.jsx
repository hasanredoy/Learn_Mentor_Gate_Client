...
const Profile = () => {
  ...
  return (
    <div className=" min-h-screen justify-center items-center flex flex-col  lg:flex-row">
      ...
      <div className="   flex flex-col justify-center items-center  w-full lg:w-1/2 gap-5 bg-amber-50  h-auto lg:h-[500px] py-5" >
      ...
      <div className=" py-5 h-auto lg:h-[500px]  flex flex-col bg-blue-100 justify-center items-start w-full lg:w-1/2 gap-5 border-l-0  pl-5" >
